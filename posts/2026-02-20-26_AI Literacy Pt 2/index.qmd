...
There are many more examples I could give, but let me end with this one. I wanted to see how Claude Code would do on an IRT empirical analysis project I'd assigned to my students. It's a project that I'd expect would require my students somewhere between 5 and 8 hours (or maybe more) to complete, because they have to actively learn IRT content to complete the task. Claude already has all that content effectively stored in its model parameters, and thus finished the assignment in 18 minutes. Generally speaking, it was way better than what my students would turn in.
